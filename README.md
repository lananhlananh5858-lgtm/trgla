# Creating the requested HTML page with the user's exact content and saving it to /mnt/data/lan-anh-bio.html
html = """<!doctype html>
<html lang="vi">
<head>
  <meta charset="utf-8" />
    ...
    <section id="i">
      ...
      <div class="meta">
        <ol>
          ...
          <li><strong>Quê quán:</strong> Mai Động, Phù Khê, Bắc Ninh</li> 
        </ol>
      </div>
    </section>
...
path = "/mnt/data/lan-anh-bio.html"
with open(path, "w", encoding="utf-8") as f:
    f.write(html)

{"saved_path": path, "size_bytes": len(html)}o
